...
#if (defined(DUST_DIFFUSE) && !(defined(VISCOSITY) || defined(ALPHAVISCOSITY)))
  mastererr ("Error - You cannot active dust diffusion without viscoity.\n") ;
  mastererr ("Set on of the VISCOSITY or ALPHAVISCOSITY flags\n").;
  prs_exit(1) ;
#endif
