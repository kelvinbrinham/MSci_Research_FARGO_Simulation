...
#define VYTEMP 4096L
#define VZTEMP 8192L
#define DUST_DENS 16384L
#define DUST_VX   32768L
#define DUST_VY   65536L
#define DUST_VZ  131072L
...
#ifdef GHOSTSX
#define l2D_XY ((i)+(j)*(Nx+2*NGHX))
#else
#define l2D_XY ((i)+(j)*(Nx))
